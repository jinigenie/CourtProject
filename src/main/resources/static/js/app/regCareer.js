...
$('#caAddBtn').click(function () {
    ...
    career += '<td data-cell-header="부서"><input type="text" class="input-wrap" style="width: 120px" name="work_department"></td>'
    career += '<td data-cell-header="직책"><input type="text" class="input-wrap" style="width: 120px" name="work_position"></td>'
    career += '<td data-cell-header="수행업무"><input type="text" class="input-wrap" style="width: 180px" name="work_description"></td>'
    ...
    career += 'name="work_start_date" value="" style="width: 150px; height: 40px; border-radius: 0; background-position-x: 123px; background-position-y: 10px; cursor: pointer;"/></div></td>'
    career += '<td data-cell-header="근무종료일">'
    career += '<div class="calander-box" style="padding: 0">'
    career += '<input type="text" class="datepicker" readonly placeholder="날짜선택"'
    career += 'name="work_end_date" value="" style="width: 150px; height: 40px; border-radius: 0; background-position-x: 123px; background-position-y: 10px; cursor: pointer;"/></div></td>'
