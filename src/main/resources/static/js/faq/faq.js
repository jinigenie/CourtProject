...
function faqList(page, amount, content1, content2) {
	...
	$.ajax({
		url: "list?page=" + page + "&amount=" + amount + "&searchContent=" + content1 + "&searchContent2=" + content2,
		...
		success: function(data) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				str += '<li onclick="faqToggle(this)"  class="faqList list-item" value="'+ i +'">';
